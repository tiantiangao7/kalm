...
adj_tr_comp(WordForm, Word, Prep) :- clex_switch(on), clex_adj_tr_comp(WordForm, Word, Prep).
...
pndef_sg(WordForm, Word, Gender) :- clex_switch(on), clex_pndef_sg(WordForm, Word, Gender).
