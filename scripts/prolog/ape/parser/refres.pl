...
%:- use_module(error_logger, [add_error_message_once/4, add_warning_message_once/4]).
%:- use_module(lexicon_interface, [noun_pl/3]).

:- import member/2, reverse/2, append/3, length/2, select/3 from basics.
...
resolve_anaphors(drs(ReferentsIn, ConditionsIn), DRSOut, CorefList) :-
  catch(call(resolve_anaphors1(drs(ReferentsIn, ConditionsIn), DRSOut), CorefList), CatchType, add_error_message_once(anaphor, '', CatchType, 'Send screenshot to APE developers.')).

resolve_anaphors1(drs(ReferentsIn, ConditionsIn), drs(ReferentsOut, ConditionsOut),CorefList) :-
  ...
  resolve_all_anaphors(drs(ReferentsIn, ConditionsInUpdated), ConditionsAllOut, AntecedentsIn, _AntecedentsOut, [], _ProperNamesOut, drs(ReferentsOut, ConditionsIntermediate),[],CorefList),
...
resolve_all_anaphors(drs(Referents, []), _ConditionsAllIn, AntecedentsIn, AntecedentsOut, ProperNames, ProperNames, drs(Referents, []), CorefListIn, CorefListIn) :-
  !,
  (
    var(AntecedentsOut)
    ->
...
resolve_all_anaphors(drs(ReferentsIn, [Condition|Conditions]), ConditionsAllIn, AntecedentsIn, AntecedentsOut, ProperNamesIn, ProperNamesOut, DRSOut,CorefListIn,CorefListOut) :-
  (
    ...
    resolve_all_anaphors(drs(ReferentsIn, Conditions), ConditionsAllIn, AntecedentsIn, AntecedentsOut, ProperNamesIn, ProperNamesOut, drs(ReferentsOut, ConditionsOut),CorefListIn,CorefListOut)
  ;
    % antecedent
    ...
    % continue loop
    resolve_all_anaphors(drs(ReferentsIn, Conditions), ConditionsAllIn, AntecedentsIM, AntecedentsOut, ProperNamesIn, ProperNamesOut, DRSOut,CorefListIn,CorefListOut)
  ;
    % anaphoric reference
    ...
    (
      ...
      resolve_all_anaphors(drs(ReferentsIn, PermutedConditions), ConditionsAllIn, AntecedentsIn, AntecedentsOut, ProperNamesIn, ProperNamesOut, DRSOut, CorefListIn,CorefListOut)
    ;
      % anaphor is in textual order
      resolve_one_anaphor(drs(ReferentsIn, Conditions), ConditionsAllIn, ConditionsAllOut, Condition, AntecedentsIn, AntecedentsIntermediate, ProperNamesIn, ProperNamesIM, drs(ReferentsIM, ConditionsIM),CorefPair),     
      % continue loop
      basics:append(CorefListIn,CorefPair,CorefListIn2),
      resolve_all_anaphors(drs(ReferentsIM, ConditionsIM), ConditionsAllOut, AntecedentsIntermediate, AntecedentsOut, ProperNamesIM, ProperNamesOut, DRSOut,CorefListIn2,CorefListOut)
    )
  ;
    % nested list
    is_list(Condition)
    ...
    resolve_all_anaphors(drs(ReferentsIn, Condition), ConditionsAllIn, AntecedentsIn, AntecedentsTemp, ProperNamesIn, ProperNamesTemp, drs(ReferentsTemp, ConditionListOut),CorefListIn,CorefListTmp),
    resolve_all_anaphors(drs(ReferentsTemp, Conditions), ConditionsAllIn, AntecedentsTemp, AntecedentsOut, ProperNamesTemp, ProperNamesOut, drs(ReferentsOut, ConditionsOut), CorefListTmp,CorefListOut)
  ;
    % embedded DRSs 
    (
      % negation
    ...
    ;
	  % opposes
      Condition = opposes(drs(ReferentsNIn, ConditionsNIn))
	;
      % single command
    ...
    resolve_all_anaphors(drs(ReferentsNIn, ConditionsNInUpdated), ConditionsAllOut, AntecedentsInUpdated, AntecedentsInUpdated, ProperNamesIn, ProperNamesIM, drs(ReferentsIntermediate, ConditionsIntermediate1), CorefListIn,CorefListTmp),
    ...
    resolve_all_anaphors(drs(ReferentsIn, Conditions), ConditionsAllIn, AntecedentsInPlusProperNames, AntecedentsOut, ProperNamesIM, ProperNamesOut, drs(ReferentsOut, ConditionsOut), CorefListTmp,CorefListOut),
  ...
  ;
    ...
    resolve_all_anaphors(drs(Referents1In, Conditions1InUpdated), ConditionsAllPlusConsequence, AntecedentsIM1, AntecedentsIM2, ProperNamesIn, ProperNamesIM1, drs(Referents1Out, Conditions1Intermediate), CorefListIn,CorefListOut1), 
    enforce_order(Conditions2In, Conditions2InUpdated, ConditionsAllIM1, ConditionsAllIM2, AntecedentsIM2, AntecedentsIM3),
    resolve_all_anaphors(drs(Referents2In, Conditions2InUpdated), ConditionsAllIM2, AntecedentsIM3, _AntecedentsOut, ProperNamesIM1, ProperNamesIM2, drs(Referents2Out, Conditions2Intermediate1), CorefListOut1,CorefListOut2),
    % continue on the previous DRS nesting level with ConditionsAllIn and with AntecedentsIn extended by antecedents for proper names found on this level
    decrease_DRS_nesting_level,
    add_proper_name_antecedents(ProperNamesIn, ProperNamesIM2, AntecedentsIn, AntecedentsInPlusProperNames),
    resolve_all_anaphors(drs(ReferentsIn, Conditions), ConditionsAllIn, AntecedentsInPlusProperNames, AntecedentsOut, ProperNamesIM2, ProperNamesOut, drs(ReferentsOut, ConditionsOut), CorefListOut2,CorefListOut),
    % remove duplicate conditions that are artefacts of anaphors like "the cat of the man" that could not be resolved
    % and thus could leave two conditions for "man"
  ...
  ;
	% embedded DRSs: weak implication
    Condition = drs(Referents1In, Conditions1In) ~~> drs(Referents2In, Conditions2In)
    ->
    increase_DRS_nesting_level,
    % enforce ordering and resolve anaphors on the current DRS nesting level
  ...
  ;
    ...
    resolve_all_anaphors(drs(Referents1In, Conditions1InUpdated), ConditionsAllIM, AntecedentsInUpdated, AntecedentsIM, ProperNamesIn, ProperNamesIM1, drs(Referents1Out, Conditions1Intermediate), CorefListIn,CorefListOut1),
    ...
    resolve_all_anaphors(DisjunctRestIn, ConditionsAllOut, AntecedentsIMUpdated, _AntecedentsOut, ProperNamesIM1, ProperNamesIM2, drs(ReferentsRestOut, ConditionsRestIntermediate), CorefListOut1,CorefListOut2),
    % continue on the previous DRS nesting level with ConditionsAllIn and with AntecedentsIn extended by antecedents for proper names found on this level
    decrease_DRS_nesting_level,
    add_proper_name_antecedents(ProperNamesIn, ProperNamesIM2, AntecedentsIn, AntecedentsInPlusProperNames),
    resolve_all_anaphors(drs(ReferentsIn, Conditions), ConditionsAllIn, AntecedentsInPlusProperNames, AntecedentsOut, ProperNamesIM2, ProperNamesOut, drs(ReferentsOut, ConditionsOut), CorefListOut2,CorefListOut),
...
resolve_one_anaphor(drs(ReferentsIn, ConditionsIn), ConditionsAllIn, ConditionsAllOut, Anaphor, AntecedentsIn, AntecedentsOut, ProperNamesIn, ProperNamesOut, drs(ReferentsOut, ConditionsOut),CorefPair) :-
  (
    ...
    (
      ...
      CorefPair = [coref(AnaphorSID/AnaphorTID,AntecedentSID/AntecedentTID)]
    ;
   ...
   ;
      ...
      (
        ...
        ;
          % plural anaphor
          % AnaphorCount > 1
          noun_pl(AnaphorNoun, AnaphorTokens, _Gender)
          ->
          true
        ;
  ...
  ;
    ...
    (
      ...
      member(proper_name(_ID, _AnaphorReferent, AnaphorConditions, AnaphorGenus, AnaphorNumerus, AnaphorPerson, _SID, _TID, AnaphorTokens), ProperNamesIn) 
      -> 
      ReferentsOut = ReferentsIn,
      ConditionsOut = ConditionsIn,
      ConditionsAllOut = ConditionsAllIn,
...
delete(L1,Elem,L2):-
	...
	( delete_ith(1,L1,Elem,L)
	->
		delete(L,Elem1,L2)
	;
		[H|T] = L1, delete(T,Elem,L), L2 = [H|L]
	).
%-----------------------------------------------------------------------------------------------------------------------------------------------------------------
%
...
remove_duplicate_conditions([Condition|RestConditions], Singles, ConditionsWithoutDuplicates) :-
  (
    ...
    ConditionProper \= object(_,_,named,_,_,_),
...
match_elements([Element|Elements], Set) :-
  ...
  ;
    ...
    match_elements(Conditions2, Conditions1)
  ;
	% complex condition: opposes
    Element = opposes(drs(_Referents1, Conditions1))
    ->
    member(opposes(drs(_Referents2, Conditions2)), Set),
    match_elements(Conditions1, Conditions2),
    match_elements(Conditions2, Conditions1)
  ;
  ...
  ;
    % complex condition: weak implication
    Element = drs(_ReferentsP1, ConditionsP1) ~~> drs(_ReferentsC1, ConditionsC1)
    ->
    member(drs(_ReferentsP2, ConditionsP2) ~~> drs(_ReferentsC2, ConditionsC2), Set),
 	match_elements(ConditionsP1, ConditionsP2),
